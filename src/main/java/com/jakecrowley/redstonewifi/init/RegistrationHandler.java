...
public class RegistrationHandler
{
    ...
    public static class Blocks
    {
        ...
        {
            RSWifiAppMod.getLogger().info("Registering blocks");
    ...
    public static class Items
    {
        ...
        {
            RSWifiAppMod.getLogger().info("Registering items");
    ...
    public static class Recipes
    {
        ...
        {
            RSWifiAppMod.getLogger().info("Registering recipes");
    ...
    public static class Models
    {
        ...
        {
            RSWifiAppMod.getLogger().info("Registering models");
